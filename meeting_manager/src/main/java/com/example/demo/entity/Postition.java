 ...
 *//**
	 * 职位表
	 *//*
		 * @Entity public class Postition implements Serializable { private static final
		 * long serialVersionUID = 1L;
		 * 
		 * @Id
		 * 
		 * @GeneratedValue(strategy = GenerationType.IDENTITY) private Integer
		 * positionId; // 部门编号 private String positionName; //职位等级
		 * 
		 ...
		 * positionname; }
		 * 
		 * public Postition(Integer positionid, String positionname) { super();
		 * this.positionId = positionid; this.positionName = positionname; }
		 * 
		 * public Postition() { super(); }
		 * 
		 * @Override public String toString() { return "Postition [positionId=" +
